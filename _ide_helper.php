 ...
 * Generated for Laravel 5.7.7 on 2018-10-03 20:19:58.
 *
...
namespace App\Facades { 
    ...
    class Logger {
        ...
        public static function debug($message, $context = array())
        {
            return \App\Libraries\Logger::debug($message, $context);
        }
        ...
        public static function info($message, $context = array())
        {
            return \App\Libraries\Logger::info($message, $context);
        }
...
namespace  { 
    ...
    class Logger extends \App\Facades\Logger {}
